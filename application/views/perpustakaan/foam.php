<!-- <div class="card shadow-sm">
    ...
    <div class="card-body">
        <form action="<?= site_url('perpustakaan/save') ?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id_buku" value="<?= isset($buku->id_buku) ? $buku->id_buku : '' ?>">
            <div class="form-group">
                <label>Judul Buku</label>
                <input type="text" name="judul" class="form-control" required value="<?= isset($buku->judul) ? $buku->judul : '' ?>">
            </div>
            <div class="form-group">
                <label>Pengarang</label>
                <input type="text" name="pengarang" class="form-control" required value="<?= isset($buku->pengarang) ? $buku->pengarang : '' ?>">
            </div>
            <div class="form-group">
                <label>Tahun Terbit</label>
                <input type="number" name="tahun_terbit" class="form-control" required value="<?= isset($buku->tahun_terbit) ? $buku->tahun_terbit : '' ?>">
            </div>
            <div class="form-group">
                <label>Deskripsi</label>
                <textarea name="deskripsi" class="form-control"><?= isset($buku->deskripsi) ? $buku->deskripsi : '' ?></textarea>
            </div>
            <div class="form-group">
                <label>Upload File Buku (PDF)</label>
                <input type="file" name="file_buku" class="form-control-file">
            </div>
