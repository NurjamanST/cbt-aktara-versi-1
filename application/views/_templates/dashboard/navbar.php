...
<nav class="main-header navbar navbar-expand navbar-white navbar-light shadow">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <span class="nav-link text-dark"><b>Tahun Pelajaran : <?= isset($tp_active) ? $tp_active->tahun : "Belum di set" ?> Semester : <?= isset($smt_active) ? $smt_active->nama_smt : "Belum di set" ?></b></span>
        </li>
