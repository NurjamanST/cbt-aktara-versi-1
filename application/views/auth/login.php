<div class="container pt-4">
    <div class="info-box bg-transparent shadow-none">
        <?php
            $logo_app = $setting->logo_kanan == null ? base_url() . 'assets/img/LogoAppsSmall.png' : base_url() . $setting->logo_kanan;
        ?>
        <img src="<?= $logo_app ?>" style="width: 100px;" class="bg-white p-2 rounded-lg">
        <div class="info-box-content rounded-lg bg-primary ml-2 p-2" style="text-shadow: 1px 1px 2px #000000">
            <h1 class="info-box-text text-white text-wrap"><b><u><?= $setting->nama_aplikasi ?></u></b></h1>
...
<script type="text/javascript">
    ...
    var img = ["wall5.jpg", "wall6.jpg", "wall7.jpg"];
