...
class Perpustakaan extends CI_Controller {
    ...
    public function index() {
        ...
        // Ambil profile admin/guru
        $profile = $this->Dashboard_model->getProfileAdmin($user->id);
    
        $data = [
            'buku' => $this->M_perpustakaan->get_all_buku(),
            'setting' => $setting,
            'profile' => $profile
        ];
    ...
    public function add() {
        if ($this->input->post()) {
            ...
            $this->load->view('_templates/dashboard/_header', $data);
            $this->load->view('perpustakaan/foam');
            $this->load->view('_templates/dashboard/_footer');
        }
    }
    ...
    public function edit($id_buku) {
        ...
        if ($this->input->post()) {
            ...
            $this->load->view('_templates/dashboard/_header', $data);
            $this->load->view('perpustakaan/foam', $data);
            $this->load->view('_templates/dashboard/_footer');
        }
    }
    ...
    public function view_pdf($id_buku) {
        ...
        $this->load->view('_templates/dashboard/_header', $data);
        $this->load->view('perpustakaan/baca_buku', $data);
        $this->load->view('_templates/dashboard/_footer');
    }
