...
<head>
    ...
    <style>
        .gradient {
            background: linear-gradient(90deg,rgb(37, 93, 189), #98D8EF 100%);
        }
    </style>
<body id="page-top">
            ...
            <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 aos-init aos-animate" data-aos="fade-up">
                <div class="text-center text-md-center">
                    <div class="mb-3 text-white">
                        ...
                        <img style="width:300px; height:auto;" class="bg bg-white rounded-lg" src="<?= $base_url ?>assets/img/LogoApps.png">
                    </div>
                    <div class="h3 text-white">
                        <b>A</b>plikasi <b>R</b>apor,<br><b>U</b>jian dan <b>E</b>-learning
                    </div>
                </div>
            </div>
